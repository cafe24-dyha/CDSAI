...
figma.ui.onmessage = (msg) => __awaiter(void 0, void 0, void 0, function* () {
    if (msg.type === "send-message") {
        try {
            ...
            // Here we would normally call the OpenAI API, but we need to do it from the UI
            // because Figma's plugin environment doesn't support Node.js modules
            // For now, just send a message back to UI
            figma.ui.postMessage({
                type: "api-response",
